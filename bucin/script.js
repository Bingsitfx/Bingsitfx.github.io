function initengahan(){
  ...
  function tombol2(){wallpaper.style="transform: scale(1);";Tombol.style="opacity:1;transform: scale(1);";if(fungsi==2){By.innerHTML="&#128140; Kirim Wa"};hadiahnya()}
  ...
  function aktipesan4(){
    wallpaper.style="transform: scale(1.5);";kalimat.innerHTML=pesan4.innerHTML + nama + " Sayang 🥳";kalimat.style="transform:scale(1.2)";setTimeout(aktipesan5,1000);
  }
  ...
  function aktipesan10(){
    wallpaper.style="transform: scale(1.5);";
    fthilang();ftganti=5;setTimeout(ftmuncul,400);
    otoaktipesan=1;otomatis();setTimeout(toaktipesan,600);
    setInterval(berjatuhan,400);
    fungsi=2;setTimeout(tombol2,2000);
  }
  var otoaktipesan=0;
